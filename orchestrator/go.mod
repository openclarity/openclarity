...
require (
	...
	github.com/openclarity/openclarity/containerruntimediscovery/client v0.7.2 // indirect
	github.com/openclarity/openclarity/containerruntimediscovery/types v0.7.2 // indirect
