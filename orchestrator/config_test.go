...
func TestConfig(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			Name: "Custom config",
			EnvVars: map[string]string{
				"OPENCLARITY_ORCHESTRATOR_PROVIDER":                                           "docker",
				"OPENCLARITY_ORCHESTRATOR_APISERVER_ADDRESS":                                  "http://example.com:8484/api",
				"OPENCLARITY_ORCHESTRATOR_HEALTHCHECK_ADDRESS":                                "example.com:18888",
				"OPENCLARITY_ORCHESTRATOR_CONTROLLER_STARTUP_DELAY":                           "15s",
				"OPENCLARITY_ORCHESTRATOR_DISCOVERY_INTERVAL":                                 "60s",
				"OPENCLARITY_ORCHESTRATOR_SCANCONFIG_WATCHER_POLL_PERIOD":                     "45s",
				"OPENCLARITY_ORCHESTRATOR_SCANCONFIG_WATCHER_RECONCILE_TIMEOUT":               "9m",
				"OPENCLARITY_ORCHESTRATOR_SCAN_WATCHER_POLL_PERIOD":                           "46s",
				"OPENCLARITY_ORCHESTRATOR_SCAN_WATCHER_RECONCILE_TIMEOUT":                     "8m",
				"OPENCLARITY_ORCHESTRATOR_SCAN_WATCHER_SCAN_TIMEOUT":                          "24h",
				"OPENCLARITY_ORCHESTRATOR_ASSETSCAN_WATCHER_POLL_PERIOD":                      "32s",
				"OPENCLARITY_ORCHESTRATOR_ASSETSCAN_WATCHER_RECONCILE_TIMEOUT":                "7m",
				"OPENCLARITY_ORCHESTRATOR_ASSETSCAN_WATCHER_ABORT_TIMEOUT":                    "12h",
				"OPENCLARITY_ORCHESTRATOR_ASSETSCAN_WATCHER_DELETE_POLICY":                    "never",
				"OPENCLARITY_ORCHESTRATOR_ASSETSCAN_WATCHER_SCANNER_APISERVER_ADDRESS":        "http://alternative.example.com:8484/api",
				"OPENCLARITY_ORCHESTRATOR_ASSETSCAN_WATCHER_SCANNER_EXPLOITSDB_ADDRESS":       "exploitsdb.example.com",
				"OPENCLARITY_ORCHESTRATOR_ASSETSCAN_WATCHER_SCANNER_TRIVY_SERVER_ADDRESS":     "trivy.example.com",
				"OPENCLARITY_ORCHESTRATOR_ASSETSCAN_WATCHER_SCANNER_TRIVY_SCAN_TIMEOUT":       "14m",
				"OPENCLARITY_ORCHESTRATOR_ASSETSCAN_WATCHER_SCANNER_GRYPE_SERVER_ADDRESS":     "grype.example.com",
				"OPENCLARITY_ORCHESTRATOR_ASSETSCAN_WATCHER_SCANNER_GRYPE_SERVER_TIMEOUT":     "17m",
				"OPENCLARITY_ORCHESTRATOR_ASSETSCAN_WATCHER_SCANNER_YARA_RULE_SERVER_ADDRESS": "yara.example.com",
				"OPENCLARITY_ORCHESTRATOR_ASSETSCAN_WATCHER_SCANNER_CONTAINER_IMAGE":          "super-scanner:latest",
				"OPENCLARITY_ORCHESTRATOR_ASSETSCAN_WATCHER_SCANNER_FRESHCLAM_MIRROR":         "freshclam.mirror.org",
				"OPENCLARITY_ORCHESTRATOR_ASSETSCAN_ESTIMATION_WATCHER_POLL_PERIOD":           "44s",
				"OPENCLARITY_ORCHESTRATOR_ASSETSCAN_ESTIMATION_WATCHER_RECONCILE_TIMEOUT":     "6m",
				"OPENCLARITY_ORCHESTRATOR_SCAN_ESTIMATION_WATCHER_POLL_PERIOD":                "59s",
				"OPENCLARITY_ORCHESTRATOR_SCAN_ESTIMATION_WATCHER_RECONCILE_TIMEOUT":          "5m",
				"OPENCLARITY_ORCHESTRATOR_SCAN_ESTIMATION_WATCHER_ESTIMATION_TIMEOUT":         "23h",
				"OPENCLARITY_ORCHESTRATOR_ASSETSCAN_PROCESSOR_POLL_PERIOD":                    "23s",
				"OPENCLARITY_ORCHESTRATOR_ASSETSCAN_PROCESSOR_RECONCILE_TIMEOUT":              "4m",
			},
			ExpectedNewErrorMatcher: Not(HaveOccurred()),
			ExpectedConfig: &Config{
