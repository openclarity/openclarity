...
// Pointer returns a pointer to a freshly-allocated CISDockerBenchmarkResultsSortKey.
func (m CISDockerBenchmarkResultsSortKey) Pointer() *CISDockerBenchmarkResultsSortKey {
	return &m
}
