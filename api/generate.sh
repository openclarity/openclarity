...
cp client/client/kube_clarity_a_p_is_client.go /tmp/kube_clarity_a_p_is_client.go
rm -rf server/*
rm -rf client/*
...
cp /tmp/kube_clarity_a_p_is_client.go client/client/kube_clarity_a_p_is_client.go
