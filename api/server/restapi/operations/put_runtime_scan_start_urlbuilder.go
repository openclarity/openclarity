...
func (o *PutRuntimeScanStartURL) WithBasePath(bp string) *PutRuntimeScanStartURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *PutRuntimeScanStartURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on PutRuntimeScanStartURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on PutRuntimeScanStartURL")
	}
