...
func (o *GetApplicationResourcesIDURL) WithBasePath(bp string) *GetApplicationResourcesIDURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetApplicationResourcesIDURL) Build() (*url.URL, error) {
	...
	if id != "" {
		...
		return nil, errors.New("id is required on GetApplicationResourcesIDURL")
	}
...
func (o *GetApplicationResourcesIDURL) String() string {
...
func (o *GetApplicationResourcesIDURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetApplicationResourcesIDURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetApplicationResourcesIDURL")
	}
