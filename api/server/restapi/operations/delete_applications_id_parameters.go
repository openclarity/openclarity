...
// DeleteApplicationsIDParams contains all the bound params for the delete applications ID operation
...
func (o *DeleteApplicationsIDParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *DeleteApplicationsIDParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
