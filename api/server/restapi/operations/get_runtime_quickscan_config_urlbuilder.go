...
func (o *GetRuntimeQuickscanConfigURL) WithBasePath(bp string) *GetRuntimeQuickscanConfigURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetRuntimeQuickscanConfigURL) String() string {
...
func (o *GetRuntimeQuickscanConfigURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetRuntimeQuickscanConfigURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetRuntimeQuickscanConfigURL")
	}
