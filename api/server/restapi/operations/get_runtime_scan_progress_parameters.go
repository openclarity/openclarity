...
// GetRuntimeScanProgressParams contains all the bound params for the get runtime scan progress operation
...
func (o *GetRuntimeScanProgressParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
