...
func (o *DeleteApplicationsIDURL) WithBasePath(bp string) *DeleteApplicationsIDURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *DeleteApplicationsIDURL) Build() (*url.URL, error) {
	...
	var _path = "/applications/{id}"

	id := o.ID
	if id != "" {
		_path = strings.Replace(_path, "{id}", id, -1)
	} else {
		return nil, errors.New("id is required on DeleteApplicationsIDURL")
	}
...
func (o *DeleteApplicationsIDURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteApplicationsIDURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteApplicationsIDURL")
	}
