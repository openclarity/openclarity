...
func (o *GetApplicationsIDURL) Build() (*url.URL, error) {
	...
	if id != "" {
		...
		return nil, errors.New("id is required on GetApplicationsIDURL")
	}
...
func (o *GetApplicationsIDURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetApplicationsIDURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetApplicationsIDURL")
	}
