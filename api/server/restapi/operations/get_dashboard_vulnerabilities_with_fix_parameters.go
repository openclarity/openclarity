...
// GetDashboardVulnerabilitiesWithFixParams contains all the bound params for the get dashboard vulnerabilities with fix operation
...
func (o *GetDashboardVulnerabilitiesWithFixParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
