...
func (o *GetRuntimeScanProgressURL) WithBasePath(bp string) *GetRuntimeScanProgressURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetRuntimeScanProgressURL) Build() (*url.URL, error) {
	...
	var _path = "/runtime/scan/progress"
...
func (o *GetRuntimeScanProgressURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetRuntimeScanProgressURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetRuntimeScanProgressURL")
	}
