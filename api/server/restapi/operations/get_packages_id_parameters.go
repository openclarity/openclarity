...
// GetPackagesIDParams contains all the bound params for the get packages ID operation
...
func (o *GetPackagesIDParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
