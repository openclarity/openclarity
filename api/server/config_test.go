...
func TestConfig(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			Name: "Custom config",
			EnvVars: map[string]string{
				"OPENCLARITY_APISERVER_LISTEN_ADDRESS":      "example.com:8889",
				"OPENCLARITY_APISERVER_HEALTHCHECK_ADDRESS": "example.com:18888",
				"OPENCLARITY_APISERVER_DATABASE_DRIVER":     "POSTGRES",
				"OPENCLARITY_APISERVER_DB_NAME":             "testname",
				"OPENCLARITY_APISERVER_DB_USER":             "testuser",
				"OPENCLARITY_APISERVER_DB_PASS":             "testpass",
			...
			ExpectedConfig: &Config{
				...
				DBHost:             "postgresql",
				DBPort:             "5432",
				DBSSLMode:          dbtypes.SSLModeDisable,
