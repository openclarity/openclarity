...
func (o *PutSbomDBResourceHashURL) WithBasePath(bp string) *PutSbomDBResourceHashURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *PutSbomDBResourceHashURL) Build() (*url.URL, error) {
	...
	var _path = "/sbomDB/{resourceHash}"

	resourceHash := o.ResourceHash
	if resourceHash != "" {
		_path = strings.Replace(_path, "{resourceHash}", resourceHash, -1)
	} else {
		return nil, errors.New("resourceHash is required on PutSbomDBResourceHashURL")
	}
...
func (o *PutSbomDBResourceHashURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on PutSbomDBResourceHashURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on PutSbomDBResourceHashURL")
	}
