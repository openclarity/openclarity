...
func NewKubeClaritySBOMDBAPIsAPI(spec *loads.Document) *KubeClaritySBOMDBAPIsAPI {
	return &KubeClaritySBOMDBAPIsAPI{
		...
		GetSbomDBResourceHashHandler: GetSbomDBResourceHashHandlerFunc(func(params GetSbomDBResourceHashParams) middleware.Responder {
			return middleware.NotImplemented("operation GetSbomDBResourceHash has not yet been implemented")
		}),
		PutSbomDBResourceHashHandler: PutSbomDBResourceHashHandlerFunc(func(params PutSbomDBResourceHashParams) middleware.Responder {
			return middleware.NotImplemented("operation PutSbomDBResourceHash has not yet been implemented")
		}),
	}
}
...
func (o *KubeClaritySBOMDBAPIsAPI) Formats() strfmt.Registry {
	return o.formats
}
...
func (o *KubeClaritySBOMDBAPIsAPI) Validate() error {
	...
	if o.GetSbomDBResourceHashHandler == nil {
		unregistered = append(unregistered, "GetSbomDBResourceHashHandler")
	}
	if o.PutSbomDBResourceHashHandler == nil {
		unregistered = append(unregistered, "PutSbomDBResourceHashHandler")
	}
...
func (o *KubeClaritySBOMDBAPIsAPI) Authorizer() runtime.Authorizer {
	return nil
}
...
func (o *KubeClaritySBOMDBAPIsAPI) Context() *middleware.Context {
	if o.context == nil {
...
func (o *KubeClaritySBOMDBAPIsAPI) initHandlerCache() {
	...
	o.handlers["GET"]["/sbomDB/{resourceHash}"] = NewGetSbomDBResourceHash(o.context, o.GetSbomDBResourceHashHandler)
	if o.handlers["PUT"] == nil {
		o.handlers["PUT"] = make(map[string]http.Handler)
	}
	o.handlers["PUT"]["/sbomDB/{resourceHash}"] = NewPutSbomDBResourceHash(o.context, o.PutSbomDBResourceHashHandler)
}

// Serve creates a http handler to serve the API over HTTP
// can be used directly in http.ListenAndServe(":8000", api.Serve(nil))
func (o *KubeClaritySBOMDBAPIsAPI) Serve(builder middleware.Builder) http.Handler {
	o.Init()
