...
// Source: github.com/openclarity/kubeclarity/backend/v2/pkg/database (interfaces: ResourceTable)
...
import (
	...
	models "github.com/openclarity/kubeclarity/api/v2/server/models"
	reflect "reflect"
)
