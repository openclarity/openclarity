	...
	tests := []struct {
	...
	}{
		{
			...
			EnvVars: map[string]string{
				...
				"OPENCLARITY_AWS_IMAGE_NAME_FILTER":    "ubuntu/images/hvm-ssd/ubuntu-jammy-22.04-*",
				"OPENCLARITY_AWS_IMAGE_OWNERS":         "099720109477,amazon",
				"OPENCLARITY_AWS_INSTANCE_MAPPING":     "x86_64:t3.large,arm64:t4g.large",
				"OPENCLARITY_AWS_INSTANCE_ARCH_TO_USE": "x86_64",
