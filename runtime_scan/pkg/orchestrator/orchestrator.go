...
import (
	...
	"wwwin-github.cisco.com/eti/scan-gazr/runtime_scan/pkg/rest"
	_scanner "wwwin-github.cisco.com/eti/scan-gazr/runtime_scan/pkg/scanner"
...
//go:generate $GOPATH/bin/mockgen -destination=./mock_orchestrator.go -package=orchestrator wwwin-github.cisco.com/eti/scan-gazr/runtime_scan/pkg/orchestrator VulnerabilitiesScanner
