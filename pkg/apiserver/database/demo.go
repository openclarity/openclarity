	...
	return []models.Scan{
		{
			...
			Status:            models.NewScanStatus(models.ScanStatusStateDone, models.ScanStatusReasonSuccess, utils.PointerTo("Scan was completed successfully")),
		...
		},
		{
			...
			Status:            models.NewScanStatus(models.ScanStatusStateInProgress, models.ScanStatusReasonAssetScansRunning, utils.PointerTo("Scan is in progress")),
