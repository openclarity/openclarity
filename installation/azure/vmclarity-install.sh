...
VMCLARITY_AZURE_SCANNER_STORAGE_ACCOUNT_TYPE=__AZURE_SCANNER_STORAGE_ACCOUNT_TYPE__
VMCLARITY_AZURE_SCANNER_OS_DISK_STORAGE_ACCOUNT_TYPE=__AZURE_SCANNER_OS_DISK_STORAGE_ACCOUNT_TYPE__
