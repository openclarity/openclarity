...
| gateway.image.tag | string | `"1.27.1"` | Gateway service container tag |
...
| postgresql.image.tag | string | `"16.4.0-debian-12-r15"` | Postgresql container tag |
...
| trivyServer.image.tag | string | `"0.55.1"` | Trivy Server container tag |
