...
OPENCLARITY_GCP_SCANNER_MACHINE_ARCHITECTURE_TO_TYPE_MAPPING={ScannerMachineArchitectureToTypeMapping}
OPENCLARITY_GCP_SCANNER_MACHINE_ARCHITECTURE={ScannerMachineArchitecture}
OPENCLARITY_GCP_SCANNER_SOURCE_IMAGE_PREFIX={ScannerSourceImagePrefix}
OPENCLARITY_GCP_SCANNER_MACHINE_ARCHITECTURE_TO_SOURCE_IMAGE_MAPPING={ScannerMachineArchitectureToSourceImageMapping}
