...
require (
	...
	github.com/aquasecurity/trivy-db 9a4add6e0fd4
	...
	github.com/openclarity/openclarity/plugins/runner v1.1.2
	github.com/openclarity/openclarity/plugins/sdk-go v1.1.2
	github.com/openclarity/openclarity/utils v1.1.2
	github.com/openclarity/openclarity/workflow v1.1.2
