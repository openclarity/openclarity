...
func (o *GetSbomDBResourceHashURL) WithBasePath(bp string) *GetSbomDBResourceHashURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetSbomDBResourceHashURL) Build() (*url.URL, error) {
	...
	if resourceHash != "" {
		...
		return nil, errors.New("resourceHash is required on GetSbomDBResourceHashURL")
	}
...
func (o *GetSbomDBResourceHashURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetSbomDBResourceHashURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetSbomDBResourceHashURL")
	}
