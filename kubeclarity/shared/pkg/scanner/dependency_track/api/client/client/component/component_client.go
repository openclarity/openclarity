...
func (a *Client) GetComponentByUUID(params *GetComponentByUUIDParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetComponentByUUIDOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewGetComponentByUUIDParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "getComponentByUuid",
		Method:             "GET",
		PathPattern:        "/v1/component/{uuid}",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http", "https"},
		Params:             params,
		Reader:             &GetComponentByUUIDReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*GetComponentByUUIDOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for getComponentByUuid: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
