...
// GetApplicationsIDParams contains all the bound params for the get applications ID operation
...
func (o *GetApplicationsIDParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
