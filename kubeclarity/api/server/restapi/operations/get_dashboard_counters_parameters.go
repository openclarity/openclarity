...
// GetDashboardCountersParams contains all the bound params for the get dashboard counters operation
...
func (o *GetDashboardCountersParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
