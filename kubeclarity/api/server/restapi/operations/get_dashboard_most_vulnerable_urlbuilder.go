...
func (o *GetDashboardMostVulnerableURL) WithBasePath(bp string) *GetDashboardMostVulnerableURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetDashboardMostVulnerableURL) Build() (*url.URL, error) {
	...
	var _path = "/dashboard/mostVulnerable"
...
func (o *GetDashboardMostVulnerableURL) String() string {
...
func (o *GetDashboardMostVulnerableURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetDashboardMostVulnerableURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetDashboardMostVulnerableURL")
	}
