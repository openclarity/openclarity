...
func (o *GetDashboardCountersURL) WithBasePath(bp string) *GetDashboardCountersURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetDashboardCountersURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetDashboardCountersURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetDashboardCountersURL")
	}
