...
// GetDashboardPackagesPerLanguageParams contains all the bound params for the get dashboard packages per language operation
...
func (o *GetDashboardPackagesPerLanguageParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
