...
func (o *GetRuntimeScheduleScanConfigURL) WithBasePath(bp string) *GetRuntimeScheduleScanConfigURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetRuntimeScheduleScanConfigURL) Build() (*url.URL, error) {
	var _result url.URL
...
func (o *GetRuntimeScheduleScanConfigURL) String() string {
...
func (o *GetRuntimeScheduleScanConfigURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetRuntimeScheduleScanConfigURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetRuntimeScheduleScanConfigURL")
	}
