...
import SeverityWithCvssDisplay, {
  SEVERITY_ITEMS,
...
const FILTER_SEVERITY_ITEMS = Object.values(SEVERITY_ITEMS)
  .filter(({ valueKey }) => valueKey !== SEVERITY_ITEMS.NONE.valueKey)
...
const VulnerabilitiesTable = () => {
    ...
    () => [
      ...
      },
      {
        ...
        Cell: ({ row }) => {
          ...
          return <ExpandableList items={versions || []} />;
        },
      },
  ...
  return (
    <FindingsTablePage
      ...
      filtersConfig={[
        {
          value: "findingInfo.vulnerabilityName",
        ...
        {
          value: "findingInfo.package.name",
          label: "Package name",
          operators: [
            { ...OPERATORS.eq, valueItems: [], creatable: true },
            { ...OPERATORS.ne, valueItems: [], creatable: true },
        ...
        {
          value: "findingInfo.package.version",
