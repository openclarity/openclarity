...
const FILTER_SEVERITY_ITEMS = Object.keys(MISCONFIGURATION_SEVERITY_MAP).map(
  (severityKey) => ({
    value: severityKey,
    label: MISCONFIGURATION_SEVERITY_MAP[severityKey],
  }),
);
  ...
  const columns = useMemo(
    () => [
      ...
      },
      {
        ...
        accessor: (original) =>
          MISCONFIGURATION_SEVERITY_MAP[original.findingInfo?.severity],
      },
      {
        Header: "Description",
        id: "description",
