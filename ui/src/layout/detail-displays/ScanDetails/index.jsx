      ...
      rightPlaneDisplay={() => (
        <>
          <Title
            ...
            onClick={
              withScanLink
                ? () => navigate(`${ROUTES.SCANS}/${SCANS_PATHS.SCANS}/${id}`)
                : undefined
            }
          >
            Scan
          ...
          {withAssetScansLink && (
            <div style={{ marginTop: "50px" }}>
              ...
              >{`See asset scans (${formatNumber((jobsCompleted || 0) + (jobsLeftToRun || 0))})`}</Button>
            </div>
          )}
        </>
      )}
