...
export const ContainerImageInfoDetails = ({ assetData }) => {
  const { imageID, repoDigests, repoTags, labels, architecture, os, size } =
    assetData.assetInfo || {};
  ...
  return (
    <>
      ...
      <TitleValueDisplayRow>
        <TitleValueDisplay title="Repo digests">
      ...
      <TitleValueDisplayRow>
        <TitleValueDisplay title="Repo tags">
          {(repoTags ?? []).map((tag) => (
            <div>{tag}</div>
          ))}
        </TitleValueDisplay>
      ...
      <TitleValueDisplayRow>
        <TitleValueDisplay title="Architecture">
          {architecture}
        </TitleValueDisplay>
      ...
      <TitleValueDisplayRow>
        <TitleValueDisplay title="Labels">
          <TagsList items={formatTagsToStringsList(labels)} />
        </TitleValueDisplay>
      </TitleValueDisplayRow>
    </>
  );
