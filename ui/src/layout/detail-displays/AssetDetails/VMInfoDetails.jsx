  ...
  return (
    <>
      ...
      <TitleValueDisplayRow>
        ...
        <TitleValueDisplay title="Instance type">
          {instanceType}
        </TitleValueDisplay>
      </TitleValueDisplayRow>
      ...
      <TitleValueDisplayRow>
        ...
        <TitleValueDisplay title="Launch time">
          {formatDate(launchTime)}
        </TitleValueDisplay>
      </TitleValueDisplayRow>

      <TitleValueDisplayRow>
        <TitleValueDisplay title="Root Volume Size">
          {sizeGB} GB
        </TitleValueDisplay>
        <TitleValueDisplay title="Encrypted Root Volume">
          {encrypted}
        </TitleValueDisplay>
      </TitleValueDisplayRow>
    </>
